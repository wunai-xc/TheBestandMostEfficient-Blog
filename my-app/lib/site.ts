...
export const SITE = {
  ...
  i18n: {
    zh: { home: "首页", posts: "文章", tags: "标签", search: "搜索", archives: "归档", categories: "分类", prev: "上一篇", next: "下一篇", readingTime: "分钟阅读", words: "字", pinned: "置顶", aiWarning: "本文由 AI 生成，可能存在误区，斟酌阅读！！", comments: "评论", searchPlaceholder: "输入关键词搜索", allPosts: "全部文章", onThisPage: "本页目录", printSingle: "单面打印", printDuplex: "双面打印" },
    en: { home: "Home", posts: "Posts", tags: "Tags", search: "Search", archives: "Archives", categories: "Categories", prev: "Previous", next: "Next", readingTime: "min read", words: "words", pinned: "Pinned", aiWarning: "This article was generated by AI and may contain inaccuracies. Read with caution!", comments: "Comments", searchPlaceholder: "Search posts...", allPosts: "All Posts", onThisPage: "On this page", printSingle: "Print single-sided", printDuplex: "Print double-sided" },
  },
};
